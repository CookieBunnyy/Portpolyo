...
export default function Profile() {
  ...
  return (
    <section id="profile">
      <div className="text-left p-4 sm:p-6 rounded-2xl bg-stone-200 dark:bg-neutral-800 
        ...
        <div className="flex flex-col items-center lg:items-start gap-4 px-2 sm:px-3 shrink-0">
          ...
          >
            <AnimatePresence>
              <motion.div
                key={liked} // reanimate on liked change
        ...
        {/* Right Section */}
        <div className="flex flex-col justify-between lg:justify-start gap-4 sm:gap-6 
          ...
          <div className="flex items-center justify-between sm:justify-start gap-8 sm:gap-16 mt-4 flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <div className="text-xs sm:text-sm">
                ...
                <div className="text-base sm:text-lg font-semibold text-neutral-900 dark:text-white">2</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <div className="text-xs sm:text-sm">
                ...
                <div className="text-base sm:text-lg font-semibold text-neutral-900 dark:text-white">5</div>
              </div>
            </div>
          </div>
